...
# # RTX 4xxx
# web_scraping_itxgamer('RTX 4090', 'ITXGamer', 'itxgamer_RTX4090.pickle',  # noqa
#                    URL_BASE + '149487', 12000)  # noqa

# web_scraping_itxgamer('RTX 4080', 'ITXGamer', 'itxgamer_RTX4080.pickle',   # noqa
#                        URL_BASE + '153458', 8750)   # noqa

# web_scraping_itxgamer('RTX 4070 Ti', 'ITXGamer', 'itxgamer_RTX4070ti.pickle',  # noqa
#                    URL_BASE + '158560', 6750)  # noqa

# web_scraping_itxgamer('RTX 4070', 'ITXGamer', 'itxgamer_RTX4070.pickle',  # noqa
#                    URL_BASE + '176426', 6000)  # noqa


# # RTX 3xxx

# web_scraping_itxgamer('RTX 3090 Ti', 'ITXGamer', 'itxgamer_RTX3090ti.pickle',  # noqa
#                    URL_BASE + '131982', 8000)  # noqa

# web_scraping_itxgamer('RTX 3090', 'ITXGamer', 'itxgamer_RTX3090.pickle',  # noqa
#                    URL_BASE + '39014', 8000)  # noqa

# web_scraping_itxgamer('RTX 3080 Ti', 'ITXGamer', 'itxgamer_RTX3080ti.pickle',  # noqa
#                    URL_BASE + '131982', 8000)  # noqa

# web_scraping_itxgamer('RTX 3080', 'ITXGamer', 'itxgamer_RTX3080.pickle',  # noqa
#                    URL_BASE + '39013', 4900)  # noqa

# web_scraping_itxgamer('RTX 3070 Ti', 'ITXGamer', 'itxgamer_RTX3070ti.pickle',  # noqa
#                    URL_BASE + '87461', 3900)  # noqa

# web_scraping_itxgamer('RTX 3070', 'ITXGamer', 'itxgamer_RTX3070.pickle',  # noqa
#                    URL_BASE + '49805', 3400)  # noqa

# web_scraping_itxgamer('RTX 3060 Ti', 'ITXGamer', 'itxgamer_RTX3060ti.pickle',  # noqa
#                    URL_BASE + '55318', 2600)  # noqa

# web_scraping_itxgamer('RTX 3060', 'ITXGamer', 'itxgamer_RTX3060.pickle',  # noqa
#                    URL_BASE + '77511', 2100)  # noqa

# web_scraping_itxgamer('RTX 3050', 'ITXGamer', 'itxgamer_RTX3050.pickle',  # noqa
#                    URL_BASE + '117352', 1625)  # noqa

# RTX 2xxx e GTX 1xxx

# web_scraping_itxgamer('RTX 2060', 'ITXGamer', 'itxgamer_RTX2060.pickle',  # noqa
#                    URL_BASE + '3579', 1600)  # noqa

# web_scraping_itxgamer('GTX 1660', 'ITXGamer', 'itxgamer_GTX1660.pickle',  # noqa
#                    URL_BASE + '3602%2C3601%2C14005', 1300)  # noqa

# web_scraping_itxgamer('GTX 1650', 'ITXGamer', 'itxgamer_GTX1650.pickle',  # noqa
#                    URL_BASE + '3603', 950)  # noqa

# web_scraping_itxgamer('GTX 1630', 'ITXGamer', 'itxgamer_GTX1630.pickle',  # noqa
...
# web_scraping_itxgamer('RX 7900 XT', 'ITXGamer', 'itxgamer_RX7900.pickle',  # noqa
...
# web_scraping_itxgamer('RX 6900 XT', 'ITXGamer', 'itxgamer_RX6900XT.pickle',  # noqa
...
# web_scraping_itxgamer('RX 6800 XT', 'ITXGamer', 'itxgamer_RX6800XT.pickle',  # noqa
...
# web_scraping_itxgamer('RX 6750 XT', 'ITXGamer', 'itxgamer_RX6750XT.pickle',  # noqa
...
# web_scraping_itxgamer('RX 6700 XT', 'ITXGamer', 'itxgamer_RX6700XT.pickle',  # noqa
#                    'https://www.itxgamer.com.br/amd-radeon', 50)  # noqa

# web_scraping_itxgamer('RX 6650 XT', 'ITXGamer', 'itxgamer_RX6650XT.pickle',  # noqa
...
# web_scraping_itxgamer('RX 6600', 'ITXGamer', 'itxgamer_RX6600XT.pickle',  # noqa
...
# web_scraping_itxgamer('RX 6500 XT', 'ITXGamer', 'itxgamer_RX6500XT.pickle',  # noqa
...
# web_scraping_itxgamer('RX 6400', 'ITXGamer', 'itxgamer_RX6400.pickle',  # noqa
...
web_scraping_itxgamer('Processador', 'ITXGamer', 'itxgamer_processador.pickle',  # noqa
                   'https://www.itxgamer.com.br/processador?limit=48', 50, DATABASE_NAME_PROCESSADOR)  # noqa

# ------------- Memoria ----------------- #

web_scraping_itxgamer('Processador', 'ITXGamer', 'itxgamer_memoria.pickle',  # noqa
                   'https://www.itxgamer.com.br/memoria?limit=24', 50, DATABASE_NAME_MEMORY)  # noqa

# ------------- Placa Mãe ----------------- #

web_scraping_itxgamer('Placa Mãe', 'ITXGamer', 'itxgamer_placamae.pickle',  # noqa
                   'https://www.itxgamer.com.br/placa-mae', 50, DATABASE_NAME_MOTHERBOARD)  # noqa
